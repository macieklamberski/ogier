...
export const card: Card = {
  ...
  footer: { text: 'plotwise.example' },
  align: 'center',
}

export const style: Style = {
  theme: { ...light, bg: '#eef3e8', accent: '#3f7d3a' },
  fonts: { title: 'bricolage-grotesque', body: 'inter', label: 'jetbrains-mono' },
  sizes: { contentWidth: 960, titleTracking: '-0.035em' },
}
